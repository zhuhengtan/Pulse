...
export function createAgent(state: RuntimeState, goal: string, resume: ResumePoint, options: { agentId?: string; maxActiveLanes?: number; initialGlobal?: JsonValue; parentAgentId?: string; depth?: number; inheritedFloor?: number } = {}): { agent: AgentRecord; root: LaneRecord } {
