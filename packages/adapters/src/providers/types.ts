...
export interface ProviderPresetConfig { provider: string; apiKey?: string; baseURL?: string; defaultModel?: string; maxOutputTokens?: number; toolChoice?: ProviderToolChoice; extraHeaders?: Record<string, string> }
